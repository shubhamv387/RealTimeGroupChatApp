const socket = io("http://13.48.147.235:3000");
...
window.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    } = await axios.get(`http://13.48.147.235:3000/api/chatbox/${groupId}`, {
      headers: {
        Authorization: token,
      },
    });
...
async function findAllGroupsOfThisUser() {
  try {
    ...
    } = await axios("http://13.48.147.235:3000/api/group", {
      headers: {
        Authorization: token,
      },
    });
  ...
  try {
    if (fileUploadEle.value) {
      ...
      const { data } = await axios.post(
        `http://13.48.147.235:3000/api/chatbox/upload/${groupId}`,
        { file },
        {
          headers: {
            Authorization: token,
    ...
    const {
      ...
      `http://13.48.147.235:3000/api/chatbox/chat/${groupId}`,
      { chatText },
      {
        headers: {
          Authorization: token,
...
newGroupForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    const {
      ...
      "http://13.48.147.235:3000/api/group/create-group",
    ...
    const { data } = await axios.get("http://13.48.147.235:3000/api/users", {
      headers: {
        Authorization: token,
      },
    });
    ...
    addSelectedMemberBtn.addEventListener("click", async () => {
      ...
      try {
        const { data } = await axios.post(
          "http://13.48.147.235:3000/api/group/add-users",
